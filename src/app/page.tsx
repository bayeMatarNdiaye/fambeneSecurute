...
export default function Home() {
  return (
    <div className="space-y-24 pb-24">
      <section className="relative overflow-hidden bg-night text-foreground">
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-16 px-6 pt-32 lg:flex-row lg:items-center">
          <div className="space-y-6 lg:w-1/2">
            <Reveal>
              <p className="inline-flex items-center gap-2 rounded-full border border-border px-4 py-1 text-xs uppercase tracking-[0.25em] text-muted-foreground">
                Sécurité premium
                <span className="h-2 w-2 rounded-full bg-primary" />
              </p>
            </Reveal>
            <Reveal delay={0.1}>
              <h1 className="text-4xl font-heading font-bold leading-tight text-foreground lg:text-5xl">
            ...
            <Reveal delay={0.25}>
              <div className="flex items-center gap-6 text-sm text-muted-foreground">
                ...
                <div>
                  <p className="text-3xl font-heading text-foreground">4 min</p>
          ...
          <div className="flex flex-col gap-8 lg:w-1/2">
            <Reveal delay={0.1}>
              <div className="relative mx-auto aspect-video w-1/2 overflow-hidden rounded-2xl bg-white p-4 lg:aspect-square lg:h-auto">
                <Image
                  src="/images/fambene_logo.jpg"
                  alt="Logo Fambene Sécurité"
                  fill
            ...
            <Reveal delay={0.2}>
              <div className="glass-panel relative overflow-hidden p-6">
                ...
                <div className="mt-8 grid grid-cols-3 gap-4 text-center text-muted-foreground">
                  <div>
                    <p className="text-3xl font-heading text-foreground">18</p>
                    <p className="text-xs uppercase">Opérateurs</p>
                  </div>
                  <div>
                    <p className="text-3xl font-heading text-foreground">2</p>
                    <p className="text-xs uppercase">Backups</p>
                  </div>
                  <div>
                    <p className="text-3xl font-heading text-foreground">ISO</p>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <Reveal>
            <div className="flex flex-col gap-4">
              ...
              <h2 className="accent-underline inline-block text-3xl font-heading text-foreground">
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <Reveal>
              <div>
                ...
                <h2 className="mt-4 text-3xl font-heading text-foreground">
      ...
      <section
        ...
        style={{
          backgroundImage: "url(/images/team/agents.png)",
        }}
      >
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <Reveal>
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground">{directorMessage}</p>
